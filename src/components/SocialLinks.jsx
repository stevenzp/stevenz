...
const SocialLinks = () => {
  ...
  return (
    <div className="mx-auto p-4 rounded-xl bg-purple-900/30 backdrop-blur-sm border border-purple-500/30 hover:border-purple-500/60 transition-all duration-300" style={{ maxWidth: '200px' }}>
